...
type SwipeEngagementAction = "follow" | "like" | "save" | "share";

type MutateSwipeEngagementInput = {
  action: SwipeEngagementAction;
...
type MutateSwipeEngagementResult = {
  error: string | null;
  loginUrl: string | null;
  ok: boolean;
};

async function requireSwipeUser() {
...
export async function mutateSwipeEngagement(
  input: MutateSwipeEngagementInput
): Promise<MutateSwipeEngagementResult> {
  ...
  const auth = await requireSwipeUser();
