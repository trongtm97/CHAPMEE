...
const variantClasses = {
  ...
  discover: {
    input:
      "h-12 w-full rounded-xl border border-white/12 bg-white/[0.05] py-2.5 pl-4 pr-12 text-sm text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] outline-none placeholder:text-zinc-500 transition focus:border-cyan-400/55 focus:ring-2 focus:ring-cyan-400/20 md:h-[3.25rem] md:text-[0.9375rem]",
    button:
      "absolute right-1.5 top-1/2 flex size-9 -translate-y-1/2 items-center justify-center rounded-lg text-zinc-400 transition hover:bg-white/10 hover:text-cyan-200"
  }
} as const;
