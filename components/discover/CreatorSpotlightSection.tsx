        ...
        <div className="flex min-w-max gap-2.5 pb-0.5 pr-4 md:gap-3 md:pr-0">
          {creators.slice(0, 6).map((creator) => (
            <Link
              ...
              href={getProfileUrlOrFallback(creator.username, "/bang-xep-hang")}
              key={creator.id}
            >
              ...
              <p className="mt-2 line-clamp-2 w-full text-xs font-bold leading-snug text-zinc-100">{creator.displayName}</p>
