...
export function CoinBalancePill({
  ...
  const label = isLoggedIn ? formatCompactCoin(balance) : "Xu";

  return (
    <button
      aria-label={isLoggedIn ? `Ví Xu: ${label}` : "Đăng nhập để xem ví Xu"}
      ...
      type="button"
    >
      <span aria-hidden="true" className="text-[0.95rem] leading-none text-amber-400">
        ◉
      </span>
