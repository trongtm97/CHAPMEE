...
export type SwipeCommentView = {
  ...
  isLiked: boolean;
  replyCount: number;
  replies: SwipeCommentReply[];
  canPin: boolean;
  canDelete: boolean;
  isPinned: boolean;
};

type SwipeCommentItemProps = {
  activeReplyId: string | null;
  comment: SwipeCommentView;
...
export function SwipeCommentItem({
  activeReplyId,
  comment,
  isSubmitting,
  onLike,
