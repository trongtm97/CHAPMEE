...
export default async function AdminTaxonomyRoute({ searchParams }: PageProps) {
  ...
  const manageGroup = group !== "all" ? { type: group as TaxonomyType } : {};
  ...
  return (
    <AdminTaxonomyCenter
      ...
      initialGroup={group}
      initialTerms={initialTermsResult.items}
      initialTermsError={initialTermsResult.error}
      initialTermsTotal={initialTermsResult.total}
